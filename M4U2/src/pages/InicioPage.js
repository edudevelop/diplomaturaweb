        ...
        <main>
            <div className="holder">
                <section>
                    ...
                    <div className="funcionamiento" style={{ 
                        backgroundImage: `url("images/escaperoom.jpg")`
                    }}> 
                ...
                <section>
                    ...
                    <div className="social">
                        <ul>
                            <li>
                                <a href="https://es-la.facebook.com" target="_blank" rel="noreferrer" ><img src="images/social/fb.png"
                                        alt="facebook"/></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="https://instagram.com" target="_blank" rel="noreferrer" ><img src="images/social/ig.png"
                                        alt="instragram"/></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="https://twitter.com" target="_blank" rel="noreferrer" ><img src="images/social/tw.png"
                                        alt="twitter"/></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="https://youtube.com" target="_blank" rel="noreferrer" > <img src="images/social/yt.png"
                                        alt="youtube"/></a>
                            </li>
                        </ul>
                        <ul>
                            <li>
                                <a href="https://linkedin.com" target="_blank" rel="noreferrer" ><img src="images/social/in.png"
                                        alt="linked in"/></a>
                            </li>
                        </ul>
                    </div>
